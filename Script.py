...
<b>Only Apple Mango  CANNOT 𝙰𝙲𝙲𝙴𝚂𝚂 𝙵𝙸𝙻𝙴𝚂...//</b>
...
- Filter is the feature were users can set automated replies for a particular keyword and Mango  will respond whenever a keyword is found the message
