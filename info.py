...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🎭<b>File uploaded by : ❣[𝙵𝙸𝙻𝙼𝚂 𝙾𝙵 𝙵𝙾𝚁𝚃𝚄𝙽𝙴](https://t.me/FilmsofFortune)</b>❣\n\n🎦 <b>File Name: </b> ➥  <i>{file_name}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n  <b>New Updates Join Now</b>\n 👇👇👇👇👇👇👇👇\n\n⚡  ↭ <b>[FILMS OF FORTUNE](https://t.me/FilmsofFortune)</b> ↭  ⚡")
